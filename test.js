...
for(const token of ['beatai.games','Turn AI literacy into a team sport','CREATE PRIVATE LEAGUE','SHARED PRIVATE LEAGUE','Department battle','Team leaderboard'])assert(html.includes(token),`missing Teams page token: ${token}`);
