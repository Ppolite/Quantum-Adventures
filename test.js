...
for(const asset of ['/app.js','/infinite-replay.js','/social.js','/styles.css','/social.css'])assert(html.includes(asset),`asset not loaded: ${asset}`);
...
new Function(app);new Function(replay);new Function(social);
